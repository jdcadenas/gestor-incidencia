    ...
    <div class="py-4">
        <div class="md:flex md:justify-center mb-6">
            ...
            <div class="md:md:flex px-3">
                ...
                <input id="title" class="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" type="text" name="title" value="{{ old('title',$incident->title) }}">
            </div>
            <div class="md:md:flex px-3">
                <label  class="uppercase tracking-wide text-black text-xs font-bold mb-2" for="description">Descripción</label>
                <textarea name="description" id="description" cols="30" rows="4"class="w-full bg-gray-200 px-4 py-3 text-black border rounded-lg focus:outline-none" rows="4">{{ old('description',$incident->description) }}</textarea>

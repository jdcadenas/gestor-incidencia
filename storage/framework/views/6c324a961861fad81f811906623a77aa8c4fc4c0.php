        ...
        <div class="py-2">
            ...
            <form class="mb-4" action="" method="post">
                ...
                <div class="md:md:flex px-3">
                    ...
                    <input id="email" class="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" type="email" name="email" value="<?php echo e(old('email')); ?>">
                </div>
                <div class="md:md:flex px-3">
                ...
                <div class="md:md:flex px-3">
                    ...
                    <input id="password" class="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" type="text" name="password" value="<?php echo e(old('password',Str::random(8))); ?>">
                </div>
                    ...
                    <table class="min-w-full table-auto">
                      ...
                      <tbody class="bg-gray-200">
                        ...
                        <tr class="bg-white border-4 border-gray-200">
                          ...
                          <td class="px-8 py-2 items-center">
                            <span class="text-center ml-2 font-semibold"><?php echo e($user->name); ?></span>
                          </td>
                          <td class="px-8 py-2 items-center">
                          <a href="/usuario/<?php echo e($user->id); ?>" class="inline-block px-4 py-2 text-xs font-medium text-center text-white uppercase transition bg-blue-700 rounded shadow ripple hover:shadow-lg hover:bg-blue-800 focus:outline-none">
                              Editar
                            </a>
                            <a href="/usuario/<?php echo e($user->id); ?>/eliminar" class="inline-block px-4 py-2 text-xs font-medium leading-6 text-center text-white uppercase transition bg-yellow-500 rounded shadow ripple hover:shadow-lg hover:bg-yellow-600 focus:outline-none">
                                    Eliminar
                                  </a>
                          </td>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php /**PATH /home/usuario/proyectos/desarrollosweb/laravel/gestion-incidencias/resources/views/admin/users/index.blade.php ENDPATH**/ ?>